        ...
        <div class="span9">
          <div class="hero-unit" style=' height:90%;min-height:680px;'> 
            ...
            <form name="r" method="post" enctype="multipart/form-data" action="index.php" >
                ...
                $res = "SELECT * FROM `annonce` WHERE `id` in (SELECT `idannonce` FROM `save` WHERE`idannonceur`=".$idannonceur.") " ;
                ...
                while($row = mysql_fetch_array($req)){
                   ...
                   $nbrvote=$row['nbrvote'];
                    ...
                    <td><h3 style="display:inline-block"><u>'.'-'.$offre.' à ' ;
                        ...
                        <a class="savelieni" id="save'.$idannonce.'" onclick="save('.$idannonce.')" href="#" alt="enregistrer"><span class="lb_close saveimage" ></span></a>
                        <a class="unsavelieni" id="saved'.$idannonce.'" onclick="unsave('.$idannonce.')" href="#" alt="annuler enregistrer"><span class="lb_close savedimage" style="position:relative;top:-30px;left:1px"></span></a>
                        </td></tr>';
