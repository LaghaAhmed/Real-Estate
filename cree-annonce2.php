...
<!--**********************************************************BODY***************************************************************-->
  <body style='margin: auto;max-width: 1500px;min-width: 980px;width:80%'>
            ...
            for($i=1;$i<30;$i++){unset($_SESSION['f'.$i]);}
            ?>
        <div class="span9" >
          <div class="hero-unit" id='recherche-div' style='min-height:800px'> 
            <h1>Crée Votre Annonce</h1>
            <form name="r" method="post" enctype="multipart/form-data" action="inc/ajout-annonce.php" onload="<?php $_SESSION['i'] = 0;?>" >
        <?php if((isset($_GET["pays"]))&&(($_GET["pays"])=='f')){ ?>
  
			<div id='satelite' style="position:relative;top:-50px;left:60%">
			<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d5628753.205950256!2d3.0197692634201982!3d45.824047787020035!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2sfr!4v1395664355219" width="429" height="480" frameborder="0" style="border:0"></iframe>
			</div>
<?php }else{
?>
<div class="map" id="map" style="position:relative;border:1px dashed #000000;top:-50px;left:60%">
...
<?php };?>
<div class="menurecherchepro" style='position:relative;top:-440px'>
<table>
 <tr>
      <td>
        ...
        <input type='checkbox' name='Sat[]' id='sat' style='display:inline-block'>Satellite
    ...
    <tr  valign="top">
      ...
      <select name="catheg" id='catheg' onChange="go()" style='width:150px'>
        ...
        &nbsp&nbsp
        <INPUT type="checkbox" name="type" id="v" value="1" style='display:inline-block'> à vendre ou
        <INPUT type="checkbox" name="type1" id="l" value="2" style='display:inline-block'> à louer
      </td>
    </tr>
    <tr>
    <td> 
	 	  <div style='display:inline-block;width:13%;margin:1px;background-color:#b0c4de;'><h5>Prix</H5></div><input type='number' name='prix' placeholder="0" ><br>
      <div style='display:inline-block;width:13%;margin:1px;background-color:#b0c4de;'><h5>Surface</h5></div><input step='50' type='number' SIZE=2 MAXLENGTH='10' name='surface' placeholder="10m" width="200">
      ...
      <div style='display:inline-block;width:13%;margin:1px;background-color:#b0c4de;'><h5>description:</h5></div>
	   	<textarea rows="3" cols="40" maxlength='256' name='description'> </textarea><br>
      <div style='display:inline-block;width:13%;margin:1px;background-color:#b0c4de;'><h5>Video</H5></div><input type='yt' name='yt' placeholder="Coller un lien youtube ici" style='width:350px'><br><br>
...
<tr>
  <td colspan='3' align='right'>
    <div id='imgstore' style="line-height: 96px; width: 618px;min-height:156px;border: 2px dashed #DDDDDD;border-radius: 2px;padding:2px;">
         <div><input style='float:left;display:block;z-index:110;border:2px dashed #111;background:url(img/ajouter-des-photo.png) no-repeat;-webkit-background-size:100%;-o-background-size:100%;background-size:100%;position:relative;background-size:cover;height: 148px;width: 148px;' type="file" id="file" class='file' name="files[]" title="Choisir un fichier à télécharger" multiple accept="image/*"/></div>
    </div>
    <br />
<progress id="prog" class='progress bar' value="0" min="0" max="100"></progress>
  ...
  <tr><td colspan=3 align='right'><input type="submit" value=" Deposer l'annonce " class="butt"> </td></tr>
