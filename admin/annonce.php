    ...
    <table class="tablesorter" cellspacing="0" style='width:100%'>
      ...
      <tbody> 
        <?php 
          ...
          $res = "SELECT * FROM `annonce` where `verif`=1 ORDER BY `id` DESC";
      ...
      <tr>
          <td>
              <ul class="pagination">
                <?php if ($p!=1){ ?>  
                  <li><a href="annonce.php?p=<?php $p1=$p-1;echo $p1;?>">&laquo;</a></li> <?php };
                    ...
                    for ($i = 1; $i <= $nbr_page; $i++){ 
                        ...
                        echo'<li>';
                          if ($p==$i){
                            ...
                            echo'<a href="annonce.php?p='.$i.'">'.$i.'</a>';
                          };
                        echo'</li>';
                    } ?>

                <?php if ($p!=$nbr_page){ ?> <li><a href="annonce.php?p=<?php $p1=$p+1;echo $p1; ?>">&raquo;</a></li><?php };?>
              </ul>
          </td>
      </tr>
              <?php }?>
