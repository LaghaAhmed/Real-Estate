...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="paneau-admin.php">EAI Administation</a></h1>
	...
	<aside id="sidebar" class="column">
		...
		<footer>
			<hr />
			<p><strong>Copyright &copy; 2013 EAI Administration</strong></p>
			
		</footer>
	</aside><!-- end of sidebar -->
	
	<section id="main" class="column">
		<div class="spacer"><h1>STATISTIQUE</h></div>
	</section>
